...
![](../images/max/578/1*N-q7Pj36SfSkKnJZct4Y3Q.png)
...
![](../images/max/1032/1*6vTsCaMX9HFDrTmZbFnvcA.png)
...
![](../images/max/1017/1*d0IU2Te57a2xHqS257inVA.png)
...
![](../images/max/1414/1*XRX5FZPgJIMgfw_c-ayQHw.png)
...
![](../images/max/1416/1*6jejQhxQb7v7xX4PHQ0fQg.png)
...
![](../images/max/1265/1*ENEGB6rnCEqDsHKGCKAoEg.png)
...
![](../images/max/659/1*6LIz4nn7HtwdJAb79pRtfw.png)
...
![](../images/max/1362/1*s_GIfAvOavOqE_ACMDSlNw.png)
...
![](../images/max/760/1*ov6P4njioA4mjDaHBHat2Q.png)
...
![](../images/max/401/1*jQwwoJMoBXfU1BhRGjjYCw.png)
...
![](../images/max/920/1*k_1NH-bUsfMMvByRSWSPjQ.png)

VNC was running with root privileges so we can view the root.txt file.

![](../images/max/779/1*PI-IzUmDv4Hn17f5CWPhWw.png)
