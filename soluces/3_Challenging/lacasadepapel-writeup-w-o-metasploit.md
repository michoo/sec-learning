...
![](../images/max/593/1*haljsvScci8hHcrU5AL29g.png)
...
![](../images/max/1250/1*rXgmYgwIuWCImWIUvzU69Q.png)
...
![](../images/max/1251/1*eNTSIU8B-YnZNzqx_HlUyw.png)
...
![](../images/max/983/1*rwPT_vCMVzPCN2HRgGAfZQ.png)
...
![](../images/max/851/1*Ty9WzApObe2U9t4KFLz6uA.png)
...
![](../images/max/677/1*4q84idVkAzS6pEhG8GQWBQ.png)
...
![](../images/max/672/1*j_kk0JtL88uXTJ8VrTahQg.png)
...
![](../images/max/1124/1*iOgbIp56pz604YdvWpCeOQ.png)

Click _OK_ and we’re in!

![](../images/max/1034/1*VoUWQ9ffTYqS8m4dEynlmg.png)

Click on _SEASON-1_.

![](../images/max/1207/1*6TGMRlu4tvWrbXbHeMonmA.png)

It uses a _path_ parameter. Let’s see if it is vulnerable to LFI.

![](../images/max/1037/1*LhefQ5kud5eAl1a1qcPomw.png)
...
![](../images/max/948/1*ycZ20B55HokT0rZhDHoJ6Q.png)

View the source code on the download link.

![](../images/max/482/1*JwVXk3TtVPZ6bvPUvClA6w.png)
...
![](../images/max/640/1*4FdkepT51p13Oku42-xwZA.png)
...
![](../images/max/658/1*N1dDiAAacjYOIQ2h8VGXJw.png)
